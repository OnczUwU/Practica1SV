...
<html lang="es">
    <head>
        <title>Emmanuel Alejandro Sandoval Vasquez</title>
                    ...
                    <div class="col"></div>
                       <div class="col">
                        <div class="align-items-center">
                            <p>Emmanuel Alejandro Sandoval Vasquez</p>
                            <form name="frm-login" id="frm-login" action="core/process.php">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <button type="button" class="btn btn-primary" name="btn_entrar" id="btn_entrar">Iniciar Secion</button>
